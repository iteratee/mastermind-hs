...
import System.Socket              (AddressInfo(..), AddressInfoFlags, Family(..),
                                   HasAddressInfo(..), Protocol(..), Socket(..),
                                   accept, bind, getAddressInfo, listen, socket)
...
listenThread
  :: forall f p. (Family f, HasAddressInfo f, Protocol p, Show (SocketAddress f))
